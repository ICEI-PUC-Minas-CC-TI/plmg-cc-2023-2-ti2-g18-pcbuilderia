...
let labelConfirmCpf = document.querySelector('#labelCpf')
let validConfirmCpf = false
...
cpf.addEventListener('keyup', () => {
  if(cpf.value.length != 11){
    labelConfirmCpf.setAttribute('style', 'color: red')
    labelConfirmCpf.innerHTML = 'CPF Insira 11 números'
    cpf.setAttribute('style', 'border-color: red')
    validConfirmCpf = false
  } else {
    labelConfirmCpf.setAttribute('style', 'color: green')
    labelConfirmCpf.innerHTML = 'CPF'
    cpf.setAttribute('style', 'border-color: green')
    validConfirmCpf = true
  }
})
